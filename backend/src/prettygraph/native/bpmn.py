...
BPMN = {"fill": "#FFFFFF", "stroke": "#232F3E", "red": "#D90000", "task_w": 110, "task_h": 56}
...
def intermediate(id: str, *, type: str = "message", lane: int = 0, col: int = 0, label: str = "") -> dict:
...
def gateway(id: str, *, type: str = "exclusive", lane: int = 0, col: int = 0, label: str = "") -> dict:
