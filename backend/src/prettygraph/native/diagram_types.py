...
DIAGRAM_TYPES: dict[str, dict] = {
    ...
    "network": {
        ...
        "edge_corner": "rounded",
        "lane_strategy": "corridor",
        "grouping": "nested-region-az-subnet",
    },
    "hub_spoke": {
        "label": "Hub-and-spoke / event bus",
        "orientation": "radial",
        "edge_corner": "rounded",
        "lane_strategy": "hub-center",
        "grouping": "center-hub",
    },
    "hybrid": {
    ...
    "bpmn": {
        ...
        "orientation": "LR",
        "edge_corner": "rounded",
        "lane_strategy": "swimlane",
        "grouping": "pool-lane-phase",
    },
}
