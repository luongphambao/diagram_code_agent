...
from ..constants import WBS_PLANNER_SKILL_PATHS, _WBS_CALL_LIMIT
from .spec import SubagentSpec


def _wbs_planner_spec(*, workdir: str) -> SubagentSpec:
    """Spec for the wbs_planner subagent: decompose + estimate the WBS.
    ...
    return SubagentSpec(
        ...
        model_role="wbs_planner",
        tools=WBS_PLANNER_TOOLS,
        run_limit=_WBS_CALL_LIMIT,
        prompt_builder=build_wbs_planner_prompt,
