...
SECTION_CONTENT_CONTRACTS: tuple[SectionContract, ...] = (
    ...
    SectionContract(
        ...
        status="new_block",
        params=(_p("section_list", "Ordered list of the Roman-numeral sections in this deck."),),
        slide_count=(0, 1),
        optional=True,
    ...
    # ---- I. Executive Summary ---------------------------------------------
    SectionContract(
        key="exec_summary_divider",
        section="executive_summary",
        kind="divider",
        title="{roman}. Executive Summary",
        role="context",
        layout="Head Page",
        block="divider",
        data_source="—",
    ...
    SectionContract(
        key="exec_summary_goals_value",
        section="executive_summary",
        kind="content",
        title="EXECUTIVE SUMMARY | Goals & Value Proposition",
        role="objective",
        layout="Detail-01",
        block="goals_value",
        ...
        params=(
            _p(
                "value_props",
                "3-4 numbered value propositions, each: title + 1-2 sub-bullets "
    ...
    # ---- II. Success Story -------------------------------------------------
    SectionContract(
        key="success_story_divider",
        section="success_story",
        kind="divider",
        title="{roman}. Success Story",
        role="case_study",
        layout="Head Page",
        block="divider",
        data_source="—",
    ...
    SectionContract(
        ...
        section="success_story",
        kind="content",
        title="SUCCESS STORY | {case_title}",
        role="case_study",
        layout="Detail-01",
        block="case_study",
    ...
    SectionContract(
        key="solution_divider",
        section="solution_overview",
        kind="divider",
        title="{roman}. Solution Proposal",
        role="solution",
        layout="Head Page",
        block="divider",
        data_source="—",
    ...
    SectionContract(
        ...
        params=(
            ...
            _p(
                "subtitle",
                "One-line scope subtitle, e.g. 'Proposed Solution | Scope | Delivery'.",
                required=False,
            ),
        ),
        slide_count=(1, 1),
    ...
    SectionContract(
        key="solution_feature_list",
        section="solution_overview",
        kind="content",
        title="PROPOSED SOLUTION | Feature List",
        role="solution",
        layout="Detail-01",
        block="feature_list",
        data_source="brief.functional_requirements / blueprint (condensed to feature + one-liner)",
        status="new_block",
        params=(_p("features", "4-6 features, each: name (bold) + one-line description."),),
        required_inputs=("brief.functional_requirements",),
        slide_count=(0, 1),
        optional=True,
    ...
    SectionContract(
        ...
        status="ready",
        params=(_p("tech_rows", "Table rows: Layer | Technology | Description, one per stack layer."),),
    ...
    SectionContract(
        ...
        kind="content",
        title="PROPOSED SOLUTION | Data Flow Architecture",
        role="architecture",
        layout="Empty",
        block="diagram",
        data_source="rendered diagram out.png / out.body.png",
        status="ready",
        params=(_p("diagram_image", "Full-width architecture / data-flow diagram image (out.png)."),),
    ...
    SectionContract(
        ...
        section="scope",
        kind="content",
        title="SCOPE OF WORK | SDLC Phases",
        role="scope",
        layout="Detail-01",
        block="sdlc",
        ...
        params=(
            _p(
                "sdlc_phases",
                "6 phases (Analysis, Design, Development, Testing, Deployment, "
    ...
    SectionContract(
        key="scope_change_request",
        section="scope",
        kind="content",
        title="SCOPE OF WORK | Change Request Definition",
        role="scope",
        layout="Detail-01",
        ...
        status="new_block",
        params=(
            _p("change_request_process", "The standard BnK change-request handling process.", required=False),
        ),
        slide_count=(0, 1),
        optional=True,
    ...
    # ---- V. Project Delivery ----------------------------------------------
    SectionContract(
        key="delivery_divider",
        section="delivery_plan",
        kind="divider",
        title="{roman}. Project Delivery",
        role="effort",
        layout="Head Page",
        block="divider",
        data_source="—",
    ...
    SectionContract(
        ...
        params=(
            ...
            _p(
                "gantt_rows",
                "One row per module: code, name, start_week, end_week — "
    ...
    SectionContract(
        ...
        section="risks",
        kind="content",
        title="PROJECT DELIVERY | Risk & Mitigation",
        role="risk",
        layout="Detail-01",
        block="risk_table",
        data_source="CSM risks (risk.statement + risk.mitigation)",
        status="new_block",
        params=(_p("risks", "Risk | Mitigation table rows. Falls back to a 2-column bullet list."),),
    ...
    SectionContract(
        key="delivery_methodology",
        section="delivery_plan",
        kind="content",
        title="PROJECT DELIVERY | Development Methodology",
        role="effort",
        layout="Detail-01",
        block="methodology",
        ...
        params=(
            _p(
                "methodology",
                "Delivery methodology description (Agile/Scrum cadence, roles).",
                required=False,
            ),
        ),
        slide_count=(0, 1),
    ...
    SectionContract(
        key="delivery_post_launch",
        section="delivery_plan",
        kind="content",
        title="PROJECT DELIVERY | Post-Launch Support",
        role="effort",
        layout="Detail-01",
        block="post_launch",
        data_source="fixed SLA template (Ticket -> Analyze -> Propose -> ... -> Close)",
        status="new_block",
        params=(_p("sla_process", "Post-launch support SLA steps.", required=False),),
        slide_count=(0, 1),
        optional=True,
        notes="Near-boilerplate; static default acceptable.",
    ),
    ...
    SectionContract(
        ...
        status="new_block",
        params=(_p("opex_rows", "Recurring/operational cost table (monthly/annual)."),),
    ...
    SectionContract(
        key="reference_divider",
        section="appendix",
        kind="divider",
        title="{roman}. Reference",
        role="context",
        layout="Head Page",
        block="divider",
        data_source="—",
    ...
    SectionContract(
        key="reference_screens",
        section="appendix",
        kind="content",
        title="REFERENCE | {screen_title}",
        role="context",
        layout="Detail-01",
        block="bullets",
        data_source="feature mockups / screenshots + record_artifact_inventory",
        status="ready",
        params=(_p("screens", "Reference screens, each: title + screenshot image.", required=False),),
        slide_count=(0, 6),
        optional=True,
    ...
    SectionContract(
        ...
        layout="BnK",
        block="closing",
        data_source="template-native BnK closing layout",
        status="structural",
        params=(),
        slide_count=(1, 1),
    ...
    SectionContract(
        ...
        status="new_block+new_data",
        params=(_p("client_info", "Key-value facts: client, platform, geography, regulatory."),),
...
REQUIRED_KEYS: frozenset[str] = frozenset(
    {
        "cover",
        "exec_summary_overview",
        "solution_overview",
        "scope_sdlc",
        "delivery_effort",
        "delivery_master_plan",
        "pricing_capex",
    }
)
